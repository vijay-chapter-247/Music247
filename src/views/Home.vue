            ...
            <v-speed-dial top left class="card-title-position">
              <template v-slot:activator>
                <div class="card-title-cover rounded-xl pa-1">
                  <div
                    class="card--title display-1 text-md-h4 font-weight-bold white--text wrap--text--4"
                  >
            ...
            <v-speed-dial bottom left class="card-avatar-position">
              <template v-slot:activator>
                <div class="avatar--border-1 pa-2 ">
                  ...
                  <span
                    class="position--absolute rounded-circle border--card--1"
                  >
          ...
          <v-img src="./../assets/image_3.png" height="400">
            <v-speed-dial top left class="card-title-position">
              <template v-slot:activator>
                <div class="card-title-cover rounded-xl pa-1">
                  <div
                    class="card--title display-1 text-md-h4 font-weight-bold white--text wrap--text--3"
                  >
            ...
            <v-speed-dial bottom left class="card-avatar-position">
              <template v-slot:activator>
                <div class="avatar--border-2 pa-2">
                  ...
                  <span
                    class="position--absolute rounded-circle border--card--2"
                  >
                    <v-icon color="white">mdi-check-circle</v-icon>
                  </span>
                </div>
