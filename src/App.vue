...
<v-app class="dark">
    ...
    <v-app-bar flat app dark color="dark">
        ...
        <v-card-title class="d-lg-none font-weight-bold font--subtitle--2  white--text">
            Songs247x7
        </v-card-title>
    ...
    <v-navigation-drawer v-model="drawer" app dark color="dark" class="white--text">
        ...
        <v-btn text block v-for="item in menu" :key="item.text" :to="item.route" class="body-2 py-5 text-none ">
            ...
            <span class="font-weight-medium grey--text text" v-text="item.text">
            </span>
            <v-spacer></v-spacer>
        </v-btn>
        ...
        <v-btn text block v-for="(artist, index) in artists" :key="index" :to="artist.route" class="body-2 py-5 text-none ">
            <span class="bg--grey grey--light--text mr-5 pa-1 rounded-lg ">
                <v-icon size="18" class="icon--white grey--icon" v-text="artist.icon"></v-icon>
            </span>
            <span class="font-weight-medium grey--text text" v-text="artist.text">
            </span>
            <v-spacer></v-spacer>
        </v-btn>
