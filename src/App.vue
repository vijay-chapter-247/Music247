...
<div>
    <v-app class="dark">
        ...
        <v-app-bar flat app dark color="dark">
            ...
            <!-- <v-card-title> -->
            <v-toolbar-title class="d-lg-none mr-3 font-weight-bold font--subtitle--2  white--text">Songs247x7</v-toolbar-title>
            ...
            <v-menu offset-y>
                <template v-slot:activator="{ on, attrs }">
                    <v-btn text class="profile--btn text-none " color="dark" rounded v-bind="attrs" v-on="on">
                ...
                <v-list rounded color="dark" dark>
                    <v-list-item v-for="(item, index) in profile" :key="index" route :to="item.route">
                        <v-list-item-content>
                            <v-list-item-title class="font-weight-bold profile--text--dropdown text-center ">{{ item.title }}</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-list>
            </v-menu>
        ...
        <v-navigation-drawer v-model="drawer" app dark color="dark" class="white--text">
            ...
            <!-- Menu Section -->
            <v-btn text block v-for="item in menu" :key="item.text" :to="item.route" class="body-2 py-5 text-none ">
                <span class="bg--grey grey--light--text mr-5 pa-1 rounded-lg">
                    <v-icon size="18" class="icon--white grey--icon" v-text="item.icon"></v-icon>
                </span>
                <span class="font-weight-medium grey--text text font-weight-bold  text-capitalize" v-text="item.text">
                </span>
                <v-spacer></v-spacer>
            </v-btn>
        ...
        <!-- <v-footer color="lightdark" app :height="playerHeight">
            ...
            <span class="wrap--text--1">
                <v-hover v-slot="{ hover }">
                    <v-btn text fab v-bind="size" :class="{ 'bg--orange ': hover }" class="white--text no-background-hover" @click="decrement">
                        <v-icon>mdi-skip-previous</v-icon>
                    </v-btn>
                </v-hover>

                <v-hover v-slot="{ hover }">
                    <v-btn text fab v-bind="size" :class="{ 'bg--orange ': hover }" class="white--text no-background-hover mx-sm-5 mx-1">
                        <v-icon>mdi-skip-backward</v-icon>
                    </v-btn>
                </v-hover>

                <v-hover v-slot="{ hover }">
                    <v-btn text fab v-bind="size" :class="{ 'bg--orange': hover }" class="bg--orange  white--text no-background-hover" @click="player = !player">
                ...
                <v-hover v-slot="{ hover }">
                    <v-btn text fab v-bind="size" :class="{ 'bg--orange ': hover }" class="white--text no-background-hover" @click="increment">
...
export default {
    ...
    created() {
        ...
        spotifyApi.setAccessToken(
            "BQBw511w4kZe0b6H3XqxiPymaQzTQKwZyCzIZ8SqRdq33zbbNlJwJ9qdcfXXOSUYbnoA4iq0xPIITjZXu0T3DpgHkuZyD53KW1uxIrEN0lPj4D7GA6FJ5aKP0hdTAPE4G9q6ibnldsSD4OnewZVprKBZtNkgsuyqBPDqdrxY0wffjDHuLbuAVDlguXNGu4qJuW1kPIZhglcMP8K0BiAocrTpKYlMJ4RJtFufWI0mUINWTy7fPV6S4hQf6g42cG-QSQadtPTWkV1v5y2Xkm008D6C9-rQlHaCtvCInS4J"
        );
